...
class ExtractedTextCleaner
{
    ...
    public static String clean( final String value )
    {
        ...
        cleanedText = cleanLeadingAndTrailingWS( cleanedText );
    ...
    {
        return original.replaceAll( CONSECUTIVE_HORIZONTAL_WHITESPACE, " " ).replaceAll( CONSECUTIVE_LINE_BREAKS, SYSTEM_LINE_SEPARATOR );
    }
    ...
    private static String cleanLeadingAndTrailingWS( final String original )
    {
